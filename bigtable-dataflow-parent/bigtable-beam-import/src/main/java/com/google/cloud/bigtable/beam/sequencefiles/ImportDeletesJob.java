 ...
 *   -DmainClass=com.google.cloud.bigtable.beam.sequencefiles.ImportDeletesJob \
...
public class ImportDeletesJob {
    static final long BUNDLE_SIZE = 100 * 1024 * 1024;

    public interface ImportDeletesOptions extends GcpOptions {
    ...
    public static void main(String[] args) {
        PipelineOptionsFactory.register(ImportDeletesOptions.class);

        ImportDeletesOptions opts =
            PipelineOptionsFactory.fromArgs(args).withValidation().as(ImportDeletesOptions.class);
    ...
    @VisibleForTesting
    static Pipeline buildPipeline(ImportDeleteOptions opts) {
        ...
        pipeline
            ...
            .apply("Create Mutations", ParDo.of(new HBaseResultToDeleteMutationFn()))
    ...
    static PTransform<PCollection<Mutation>, PDone> createSink(ImportDeletesOptions opts) {
        CloudBigtableTableConfiguration config =
            TemplateUtils.buildImportConfig(opts, "SequenceFileImportDeletesJob");
